...
class datamasterController extends Controller
{
    ...
    public function tulisfile($tabel, $teks, $lsupdate)
    {
        ...
        switch ($tabel) {
            ...
            case 'stock':
                ...
                if (substr($val0, -1) == '-') {
                    $val0 = trim(substr($val0, -1)) . trim(substr($val0, 0, strlen($val0) - 1));
                }
                if (substr($val1, -1) == '-') {
                    $val1 = trim(substr($val1, -1)) . trim(substr($val1, 0, strlen($val1) - 1));
                }
                if (substr($val2, -1) == '-') {
                    $val2 = trim(substr($val2, -1)) . trim(substr($val2, 0, strlen($val2) - 1));
                }
                if (substr($val3, -1) == '-') {
                    $val3 = trim(substr($val3, -1)) . trim(substr($val3, 0, strlen($val3) - 1));
                }
                if (substr($val4, -1) == '-') {
                    $val4 = trim(substr($val4, -1)) . trim(substr($val4, 0, strlen($val4) - 1));
                }
            ...
            case 'hutangkmk':
                ...
                if (substr($val5, -1) == '-') {
                    $val5 = trim(substr($val5, -1)) . trim(substr($val5, 0, strlen($val5) - 1));
                }
                if (substr($val6, -1) == '-') {
                    $val6 = trim(substr($val6, -1)) . trim(substr($val6, 0, strlen($val6) - 1));
                }
                if (substr($val7, -1) == '-') {
                    $val7 = trim(substr($val7, -1)) . trim(substr($val7, 0, strlen($val7) - 1));
                }
            ...
            case 'budget&actual':
                ...
                if (substr($val8, -1) == '-') {
                    $val8 = trim(substr($val8, -1)) . trim(substr($val8, 0, strlen($val8) - 1));
                }
                if (substr($val9, -1) == '-') {
                    $val9 = trim(substr($val9, -1)) . trim(substr($val9, 0, strlen($val9) - 1));
                }
                if (substr($val10, -1) == '-') {
                    $val10 = trim(substr($val10, -1)) . trim(substr($val10, 0, strlen($val10) - 1));
                }
            ...
            case 'lc':
                ...
                if (substr($val11, -1) == '-') {
                    $val11 = trim(substr($val11, -1)) . trim(substr($val11, 0, strlen($val11) - 1));
                }
                if (substr($val12, -1) == '-') {
                    $val12 = trim(substr($val12, -1)) . trim(substr($val12, 0, strlen($val12) - 1));
                }
            ...
            case 'margin':
                ...
                if (substr($val13, -1) == '-') {
                    $val13 = trim(substr($val13, -1)) . trim(substr($val13, 0, strlen($val13) - 1));
                }
    ...
    public function kalkulasi_hurangLC()
    {
        $hutang_lc = DB::table('hutang_lc')
            ->select(
                DB::RAW('DATE_FORMAT(DATELOAD,"%Y-%m-%d") AS TANGGAL'),
                'DOCUMENT_CURRENCY',
    ...
    public function kalkulasi_cash()
    {
        $cash = DB::table('cash')
            ->select(
                DB::RAW('@d:= DATE_FORMAT(DATELOAD,"%Y-%m-%d") AS TANGGAL'),
                'CURRENCY',
