<h4 class="text-primary text-center p-5">
    ...
    <p>JUMLAH KARYAWAN BERDASARKAN PENDIDIKAN TAHUN {{ $select_tahun }}</p>
</h4>
    ...
    <table class="table table-bordered table-hover">
        <thead>
            <tr class="bg-primary">
                ...
                <th rowspan="2" class="text-center text-white" style="vertical-align : middle;text-align:center;">PENDIDIKAN<br>( PT KS INTI )</th>
