...
<script type="text/javascript">
	...
	function getData() {
        $.get('{{ url('poeqbln') }}',  function(datanya, textStatus, xhr) {
		...
		//var data_produk = data.produk;
		 FusionCharts.ready(function() {
			chartObj = new FusionCharts({
				...
				dataSource : {
						"chart": {
							"caption": "KOMPOSISI PO  NON SUKU CADANG, SUKU CADANG & SERVICE (NILAI & ITEM)",
			...
			chartObj = new FusionCharts({
				...
				dataSource : {
						"chart": {
							"caption": "KOMPOSISI PO TERBIT -NSC (NILAI & ITEM",
							"subCaption": "September 2017",
							"startingAngle": "120",
							"showLabels": "0",
							"showLegend": "1",
			...
			chartObj = new FusionCharts({
				...
				dataSource : {
						"chart": {
							"caption": "KOMPOSISI PO TERBIT - SUKU CADANG (NILAI & ITEM)",
							"subCaption": "September 2017",
							"startingAngle": "120",
							"showLabels": "0",
							"showLegend": "1",
			...
			chartObj = new FusionCharts({
				...
				dataSource : {
						"chart": {
							"caption": "KOMPOSISI PO TERBIT - SERVICE (NILAI & ITEM",
							"subCaption": "September 2017",
							"startingAngle": "120",
							"showLabels": "0",
							"showLegend": "1",
...
<div class="panel panel-inverse" >
	<div class="panel-heading">
		...
		<h4 class="panel-title"><span class="fa fa-dashboard"></span> Purchase Order </h4>
	</div>
